...
import com.livetv.android.helper.TVRecyclerView;
import com.livetv.android.helper.TVRecyclerViewAdapter;
...
import static com.livetv.android.BR.liveCategory;
import static com.livetv.android.BR.liveCategoryAdapter;
...
public class LiveCategoryAdapter extends TVRecyclerViewAdapter<LiveCategoryAdapter.MyViewHolder> {
    ...
    protected void onDataBinding(MyViewHolder holder, int position) {
        ...
        holder.getViewDataBinding().setVariable(liveCategory, category);
        holder.getViewDataBinding().getRoot().setTag(position);
        holder.getViewDataBinding().setVariable(liveCategoryAdapter, this);
