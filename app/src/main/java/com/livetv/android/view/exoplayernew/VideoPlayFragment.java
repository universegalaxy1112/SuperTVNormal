package com.livetv.android.view.exoplayernew;
...
//        if (playbackState == ExoPlayer.STATE_READY) {
    ...
    private void showToastError() {
        if (liveTVToggleListener != null)
            liveTVToggleListener.onToggleUI(true);
        Dialogs.showTwoButtonsDialog(getActivity(), R.string.ok_dialog, R.string.cancel, R.string.generic_loading_message, new DialogListener() {
