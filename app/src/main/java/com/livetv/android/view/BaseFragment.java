...
import com.livetv.android.model.ModelTypes.SelectedType;
...
public abstract class BaseFragment extends Fragment {
    ...
    public void noInternetConnection() {
        Dialogs.showOneButtonDialog((Activity) getActivity(), (int) R.string.no_connection_title, (int) R.string.no_connection_message, (OnClickListener) new OnClickListener() {
    ...
    public void noInternetConnection(OnClickListener listener) {
        Dialogs.showOneButtonDialog((Activity) getActivity(), (int) R.string.no_connection_title, (int) R.string.no_connection_message, listener);
    }
