...
public class MovieCategoryRelativeLayout extends RelativeLayout {
    public MovieCategoryRelativeLayout(Context context) {
        super(context);
    }

    public MovieCategoryRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MovieCategoryRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHeightMeasureSpec = (int)(newWidthMeasureSpec * 1.75);

        newHeightMeasureSpec = MeasureSpec.makeMeasureSpec(newHeightMeasureSpec, MeasureSpec.EXACTLY);
        newWidthMeasureSpec = MeasureSpec.makeMeasureSpec(screenWidth, MeasureSpec.EXACTLY);
